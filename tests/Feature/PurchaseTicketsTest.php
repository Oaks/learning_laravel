...
//      $this->disableExceptionHandling();
  ...
  public function cannot_purchase_tickets_another_customer_already_trying_purchase() {
    $concert = factory(\App\Concert::class)->states('published')->create()->addTickets(3);
